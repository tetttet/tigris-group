    ...
    return (
        <section id="contact" className="relative py-20 md:py-[120px]">
            ...
            <div className="container px-8">
                <div className="-mx-4 flex flex-wrap items-center ml-0 lg:ml-8 mr-0 lg:mr-8">
                    <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
                        <div className="ud-contact-content-wrapper">
                            <div className="ud-contact-title mb-12 lg:mb-[150px]">
                                <span className="mb-6 block text-base font-medium text-dark dark:text-black">
                                    CONTACT US
                                </span>
                                <h2 className="max-w-[260px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-black">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="mb-[22px]">
                                    ...
                                    <input
                                        ...
                                        className="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-black"
                                        required
                                    />
                                </div>
                                <div className="mb-[22px]">
                                ...
                                <div className="mb-[30px]">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-black"
                                        required
                                    ></textarea>
                                </div>
                                <div className="mb-0">
                                    <button type="submit" className="primary-bg-blue-whiter inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-primary/90">
                                        Send
                                    </button>
                                </div>
                            </form>
